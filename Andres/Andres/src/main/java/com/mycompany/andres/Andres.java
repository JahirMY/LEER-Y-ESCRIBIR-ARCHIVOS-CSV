...
public class Andres {
    ...
    public void guardarArchivo(Computadoras data) {
        try {
            FileWriter fw = new FileWriter("ComputadorasDB.csv", true);
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter pw = new PrintWriter(bw);
           // pw.println("Modelo" + "," + "Marca" + "," + "Color" + "," + "Procesador" + "," + "Fabricante" + "," + "RAM" + "," + "Almacenamiento");
    ...
    public DefaultTableModel ListaGenerada() {
        ...
        try {
            FileReader fw = new FileReader("ComputadorasDB.csv");
